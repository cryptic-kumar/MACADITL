...
class NewPatientRecordOrchestratorTest {
    ...
    void shouldAggregateAllFourAgentsIntoExplainableResponse() {
        ...
        assertThat(response.explainability().agent1().evidences()).isNotEmpty();
        assertThat(response.explainability().agent2().explanation()).contains("threshold-based risk score");
    }
}
